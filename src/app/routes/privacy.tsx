    ...
    <div className="max-w-3xl mx-auto p-6">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          ...
          device and usage of our Site through both Google Analytics and Umami Analytics. This
          information may include your IP address, browser type, operating system, referring URLs,
          information on actions taken on the Site, and dates and times of Site visits. While Google
          Analytics uses cookies and may send data to servers in the United States, Umami is a
          privacy-focused, self-hosted web analytics service that does not use cookies and does not
          share data with third parties. All data collected by Umami is stored securely on our
          servers.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          To analyze and improve the functionality and user experience of our Site through the use
          of Google Analytics and Umami Analytics.
        </li>
        <li>
          To monitor and analyze trends, usage, and activities in connection with our Site using
      ...
      <h2 className="text-2xl font-semibold mb-2">6. Analytics</h2>
      <p className="mb-4">
        Our Site uses two analytics services to understand user behavior and improve our website:
        Google Analytics and Umami Analytics.
      </p>
      <h3 className="text-lg font-medium mb-2">6.1 Google Analytics</h3>
      <p className="mb-4">
        We use Google Analytics, a web analytics service provided by Google, Inc. ("Google"). Google
        Analytics uses cookies (text files placed on your computer) to help us analyze how users use
        the Site. The information generated by the cookie about your use of the Site (including your
        IP address) will be transmitted to and stored by Google on servers in the United States and
        other countries.
      </p>
      <p className="mb-4">
      ...
      <h3 className="text-lg font-medium mb-2">6.2 Umami Analytics</h3>
      <p className="mb-4">
        In addition to Google Analytics, we use Umami Analytics, a self-hosted and privacy-focused
        web analytics service. Unlike traditional analytics services, Umami does not use cookies and
        does not collect personal data. It only tracks anonymized usage data to help us understand
        how users interact with our Site. All analytics data is stored securely on our own servers
        and is not shared with any third parties.
      </p>
      <p className="mb-4">
        Users can also access and view some of the analytics data collected by Umami via the
        following link:{' '}
        <a
          href="https://analytics.egdata.app/share/m0wfDVviVELFxSHD/egdata.app"
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-500"
        >
      ...
      <p className="mb-4">
        By using our Site, you consent to the collection of usage data by Umami Analytics. If you
        did not accept the Privacy Policy, we won't send any data to Google Analytics.
      </p>
